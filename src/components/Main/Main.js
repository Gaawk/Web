...
const Main=  ({ currentUser }) =>{
	...
	console.log(currentUser.user.uuid+ ' in main')

	// <Route exact path='/' component={GaawkHomePage} />
	return (
		
		<Switch>
			
			<Route exact path='/'render={props =>
				currentUser.isAuthenticated ?	<UserHomePage 
						currentUser={currentUser}
						{...props}/> : <Landing currentUser={currentUser} {...props}/>
					}/>
			{/* ONBOARDING ROUTES */}
			<Route exact path='/signup/select-gender'render={props =>
						<AuthGender 
						// currentUser={currentUser}
						{...props}/>
					}/>
			<Route exact path='/signup/select-password'render={props =>
						<SelectPassword 
						// currentUser={currentUser}
						{...props}/>
					}/>
			<Route exact path='/confirm-by-email'render={props =>
						<SendToEmail 
						userData={currentUser.user}
						{...props}/>
					}/>
			<Route exact path='/confirm-by-number'render={props =>
						<SendToMobile 
						userData={currentUser.user}
						{...props}/>
					}/>
			<Route exact path='/check-mobile-otp'render={props =>
						<OtpToMobile 
						userData={currentUser.user}
						{...props}/>
					}/>
			<Route exact path='/check-email-otp'render={props =>
						<OtpToEmail 
						userData={currentUser.user}
						{...props}/>
					}/>
